...
@section('content')
                ...
                <div class="card-body">
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>order Name <i class="fa-solid fa-signature"></i></th>
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        @if ($order->image)
                                            <img src="{{ asset($order->image) }}" alt="{{ $order->order_name }}"
                                    ...
                                    {{-- <td>
                                        @if ($order->alert_stock >= $order->quantity)
                                            <span class="badge bg-danger">Low In Stock {{ $order->alert_stock }}</span>
                                        @else
                                            <span class="badge bg-success">Medium In Stock
                                                {{ $order->alert_stock }}</span>
                                        @endif
                                    </td> --}}
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#editorder{{ $order->id }}" class="btn btn-edit">
                                ...
                                <div class="modal right fade" id="editorder{{ $order->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title fs-5" id="exampleModalLabel"><i
                                                        class="fa fa-edit"></i> Edit order</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <br>
                                                        <textarea class="form-control" name="description" id="" cols="62" rows="3">{{ $order->description }}</textarea>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="upload-image flex-grow">
                                                            <div class="item" id="imgpreview" style="display:none">
                                                                <img src="{{ $order->image }}" class="effect8"
                                                                    alt="">
    ...
    <div class="modal right fade" id="addorder" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize for add order modal
            initializeImagePreview('addorder');

            // Initialize for each edit order modal
            document.querySelectorAll('[id^="editorder"]').forEach(modal => {
